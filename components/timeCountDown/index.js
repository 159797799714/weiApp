...
Component({
    ...
    methods: {
        getTimeString: function () {
            let {endTime, startTime, activityId,customFieldIndex, cumFormat} = this.properties
            let status;
