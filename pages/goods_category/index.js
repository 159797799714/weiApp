...
Page({
  ...
  getCategories(data) {
    ...
    //  let currentSubCatsCid=topCates[0][0].cat_id
    console.log(currentSubCats,currentSubCats.cat_list[0].cat_id, " console.log(currentSubCats) console.log(currentSubCats)")
    let cid = currentSubCats.cat_list[0].cat_id
    this.setData({
      topCates,
      currentSubCats,
      cid
  ...
  switchTopCate(event) {
    ...
    console.log(topCates, that.data.currentSubCats, tabIndex, "topCatestopCates")
    ...
    this.setData({
      ...
      activeIndexTips:0,
      cid: topCates[tabIndex].cat_list[0].cat_id,
  ...
  clickCate(event) {
    ...
    console.log(activeIndexTips, "activeIndexTipsactiveIndexTipsactiveIndexTips")
    that.setData({
      cid: id,
      activeIndexTips,
      no_more_data:"",
  ...
  productListData: function(result) {
    ...
    if (result.err_code == 0) {
      console.log(result.err_msg,"productListDataproductListDataproductListDataproductListData")
      this.setData({
  ...
  onPageScroll: function(event) {
    var that = this;
    console.log(that.data.scrollTop,that.data.scrollTop.goTopShow,"that.data.scrollTop.goTopShow ")
  ...
  bindscrolltolower: function() {
    console.log('到达底部');
    var that = this;
    console.log(that.data.activeIndex, that.data.currentSubCats.cat_list,"currentSubCatscurrentSubCatscurrentSubCats")
    ...
    if (that.data.productListData.next_page == false) {
      ...
      if ((activeIndexTips+1) < cat_list.length){
        console.log(activeIndexTips,"activeIndexTipsactiveIndexTips")
        that.setData({
  ...
  getBanner: function (){
    let that = this
    console.log(that.data.cid,"that.data.cid")
    common.post('app.php?c=category&a=find_onecategory&cat_id=' + that.data.ccid, {}, res => {
      // console.log("ssssssssssssssssssssssssrc++++", res.err_msg.cat_list[0].cat_pic)
      console.log("ssssssssssssssssssssssssrc++++", res.err_msg)
      that.setData({
