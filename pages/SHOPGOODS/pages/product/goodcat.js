...
Page({
  ...
  onLoad: function (e) { // 页面渲染完成
    ...
    let cid = e.cid ? e.cid : ""
    let group_id = e.product_id ? e.product_id:''
    this.setData({
      keyword, cid,
      group_id: group_id
    });
  ...
  onReady: function (e) {
    ...
    common.post('app.php?c=goods&a=goodcat', data, "productListData", that);
  ...
  onReachBottom: function () {
    ...
    common.post('app.php?c=goods&a=goodcat', data, "setPushData", that);       
  },
