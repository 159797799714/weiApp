    ...
    deleteImgs(e) {   //删除选择的图片
        ...
        wx.showModal({
            ...
            success (res) {
                ...
                let { index, cur } = e.currentTarget.dataset, { order_product_list } = me.data.evaluationData;
                order_product_list[index].imgList.splice(cur, 1);
                me.setData({ 'evaluationData.order_product_list': order_product_list });
            }
        })
    },
