...
Page({
    ...
    addressSave: function(e) {
        ...
        let isSelectAdd= that.data.isLoad          // 是否选择收货地址
        if(!isSelectAdd) {
          publicFun.warning('请选择所在地区', that);
          return
        } else if (that.data.order_no) {
